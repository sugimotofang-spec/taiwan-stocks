...
STOCKS = [
    ...
    {"code":"4533","name":"協易機", "group":"一軍","role":"🦾 重裝主力","ex":"otc","holding":True,
     "sweet":(28.5,30.0),"entry":(30.5,32.0),"target":(38.0,42.0),"cost":29.09,
     "memo":"伺服沖床主力，跌破 30 用力撿"},
    {"code":"3455","name":"由田",   "group":"一軍","role":"⚔️ 七殺爆量遊擊隊【地劫⚠️】","ex":"otc","holding":True,
     "sweet":(215.0,225.0),"entry":(228.0,240.0),"target":(290.0,310.0),"cost":242.50,
     "memo":"AOI 檢測設備，TSMC 自主產線指定廠商，七殺爆量型，嚴禁追高"},
    {"code":"3587","name":"閎康",   "group":"一軍","role":"🌀 天機智慧策略股","ex":"otc","holding":True,
     "sweet":(295.0,308.0),"entry":(312.0,326.0),"target":(390.0,420.0),"cost":339.53,
     "memo":"AI ASIC 可靠度分析，天機遷移智識型，2026 EPS 估 11-13，日本第四實驗室 Q3 開幕"},
    ...
    {"code":"3131","name":"弘塑",   "group":"二軍","role":"⚡ 七殺先鋒【地劫⚠️】","ex":"otc","holding":False,
